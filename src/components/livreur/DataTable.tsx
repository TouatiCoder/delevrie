            ...
            {paginatedData.length > 0 ? (
              paginatedData.map((row, index) => (
                <tr key={index} className="hover:bg-gray-50 focus-within:bg-gray-50">
                  {columns.map(column => (
                    <td key={column.key} className="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {row[column.key]}
                    </td>
                  ))}
                </tr>
              ...
              <tr>
                <td colSpan={columns.length} className="px-4 md:px-6 py-4 text-center text-sm text-gray-500" role="alert">
                  No orders found
                </td>
              </tr>
            )}
